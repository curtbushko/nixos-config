...
2. Read ALL relevant skill files for the language/framework
...
4. If ANY skills exist for the language, explicitly state:
    "I will follow the [language] skill guidelines including [key requirements]"
5. Ask user for any project-specific requirements
