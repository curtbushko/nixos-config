...
Task tool call:
  ...
  prompt: |
    ...
    - Test cases mapped to scenarios (Given/When/Then with std.testing)
...
For each task in TASKS:
  TaskCreate:
    ...
    description: "Files: {task.files} | Deps: {task.dependencies}"
...
Task tool:
  ...
  prompt: |
    ...
    **MANDATORY**: Before writing code, Read the file:
    ~/.claude/skills/zig-team/references/builder-context.md
