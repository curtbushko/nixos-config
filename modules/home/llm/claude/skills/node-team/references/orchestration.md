...
Task tool:
  ...
  prompt: |
    ...
    2. Your coding standards (MANDATORY): `~/.claude/skills/node-team/references/builder-context.md`
...
Task tool:
  ...
  prompt: |
    ...
    3. Review standards (MANDATORY): `~/.claude/skills/node-team/references/reviewer-context.md`
    ...
    ```bash
    npm run lint   # MUST pass before APPROVED verdict
    ```
...
Task tool:
  ...
  prompt: |
    ...
    3. Coding standards (MANDATORY): `~/.claude/skills/node-team/references/builder-context.md`
