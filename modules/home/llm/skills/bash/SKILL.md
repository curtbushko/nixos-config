---
name: bash
description: Use when writing, reviewing, or debugging bash/shell scripts and CLI automation. Covers safe scripting defaults (set -euo pipefail), quoting, portable POSIX-aware idioms, error handling, and composing Unix tools instead of reaching for a scripting language.
---
...
- **Go projects**: Reference the golang skill for project structure
- **Minecraft mods**: Reference the minecraft-mods skill for API interaction patterns
