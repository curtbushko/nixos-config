...
**Delegate this codebase exploration to a read-only exploration subagent when the host supports one; otherwise explore directly.**
...
3. Ask the user which modules need tests
...
- Use the to-phases skill to break into implementation phases
- Use the matching language team skill (go-team / node-team / zig-team) to execute
