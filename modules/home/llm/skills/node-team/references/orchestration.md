...
Dispatch a subagent:
  ...
  prompt: |
    ...
    5. Break down into right-sized tasks following TDD. Each task: one coherent concern, independently verifiable acceptance criteria, a reviewable diff, and enough context stated in the task for a fresh agent session.
