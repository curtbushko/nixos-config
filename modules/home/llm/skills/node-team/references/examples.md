...
```bash
Invoke the node-team skill with plan="docs/features/password-reset.md"
```
...
Invoke the node-team skill with task=3
```
...
When running the `node-team` skill:
