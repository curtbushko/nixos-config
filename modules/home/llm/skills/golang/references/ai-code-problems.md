...
- Project-level naming guidelines in the agent instruction file (CLAUDE.md / AGENTS.md)
...
### 3. Agent Hook
Configure your agent host to run lint checks after code generation (already configured in this setup).
