---
name: minecraft-mods
description: Use when managing Minecraft mods on NixOS with Packwiz. Covers adding, updating, and pinning mods, managing the modpack manifest, and integrating the pack with the Nix configuration.
---
